// <auto-generated>
//  This code was generated by the following tool on 2023-12-18 12:42:30 GMT-05:00:
...
namespace dojo_bindings
{
    public static unsafe partial class dojo
    {
        ...
        public static extern Result_____Account account_new(CJsonRpcClient* rpc, FieldElement private_key,
            CString address);
        ...
        public static extern Result_bool client_add_models_to_sync(ToriiClient* client, KeysClause* models,
            UIntPtr models_len);
        ...
        public static extern Result_____ToriiClient client_new(CString torii_url, CString rpc_url, CString world,
            KeysClause* entities, UIntPtr entities_len);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_on_entity_state_update",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern Result_bool client_on_entity_state_update(ToriiClient* client, FieldElement* entities,
            UIntPtr entities_len, FnPtr_FieldElement_CArrayModel_Void callback);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_on_sync_model_update",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern Result_bool client_on_sync_model_update(ToriiClient* client, KeysClause model,
            FnPtr_Void callback);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_remove_models_to_sync",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern Result_bool client_remove_models_to_sync(ToriiClient* client, KeysClause* models,
            UIntPtr models_len);
        ...
        public static extern Result_bool verifying_key_verify(FieldElement verifying_key, FieldElement hash,
            Signature signature);
        ...
        public struct CHashItem______c_char__ModelMetadata
        {
            ...
            public string key
            {
                get { return CString.ToString(_key); }
                set { _key = CString.FromString(value); }
            }
        ...
        public struct Call
        {
            ...
            public string to
            {
                get { return CString.ToString(_to); }
                set { _to = CString.FromString(value); }
            }
            ...
            {
                get { return CString.ToString(_selector); }
                set { _selector = CString.FromString(value); }
            }
        ...
        public struct CompositeClause
        {
            ...
            public string model
            {
                get { return CString.ToString(_model); }
                set { _model = CString.FromString(value); }
            }
        ...
        public struct Enum
        {
            ...
            public string name
            {
                get { return CString.ToString(_name); }
        ...
        public struct Error
        {
            ...
            {
                get { return CString.ToString(_message); }
                set { _message = CString.FromString(value); }
            }
        }
        ...
        public struct MemberClause
        {
            ...
            {
                get { return CString.ToString(_member); }
                set { _member = CString.FromString(value); }
            }
        ...
        public struct ValueType
        {
            ...
            {
                get { return CString.ToString(_v_string); }
                set { _v_string = CString.FromString(value); }
            }
        ...
        public struct WorldMetadata
        {
            ...
            public Span<CHashItem______c_char__ModelMetadata> models
            {
                get
                {
                    ...
                    {
                        var span = new Span<CHashItem______c_char__ModelMetadata>(@this->_models.data,
                            (int)@this->_models.data_len);
                        return span;
                    }
                }
